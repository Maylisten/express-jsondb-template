...
export function deleteFileLines(path: string, regex: string, encoding?: BufferEncoding): void;
export function deleteFileLines(path: string, regex: RegExp, encoding?: BufferEncoding): void;
...
export function replaceFileLetters(path: string, regex: string, letter: string, encoding?: BufferEncoding): void;
export function replaceFileLetters(path: string, regex: RegExp, letter: string, encoding?: BufferEncoding): void;
